...
* [#291](https://github.com/nrepl/nrepl/pull/291): Introduce CI support for MS-Windows. Fixes issue with completion middleware not returning values for local class files, or .jar files on windows.
